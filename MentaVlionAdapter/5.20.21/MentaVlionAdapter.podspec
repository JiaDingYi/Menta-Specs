Pod::Spec.new do |s|
    ...
    s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionAdapter/5.20.21/MentaVlionAdapter-5.20.21-20240523132102.tar.bz2' } 
    ...
    s.dependency 'MentaUnifiedSDK', '~> 5.20.21'
    s.dependency 'MentaVlionSDK', '~> 5.20.21'
