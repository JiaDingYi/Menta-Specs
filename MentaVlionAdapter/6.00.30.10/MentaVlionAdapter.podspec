Pod::Spec.new do |s|
    ...
    s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionAdapter/6.00.30.10/MentaVlionAdapter-6.00.30.10-20250312104855.tar.bz2' } 
