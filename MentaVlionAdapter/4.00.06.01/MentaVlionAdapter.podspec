Pod::Spec.new do |s|
    ...
    s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionAdapter/4.00.06.01/MentaVlionAdapter-4.00.06.01-20250429155421.tar.bz2' } 
    ...
    s.dependency 'MentaUnifiedSDK', '~> 4.00.06.01'
    s.dependency 'MentaVlionSDK', '~> 4.00.06.01'
