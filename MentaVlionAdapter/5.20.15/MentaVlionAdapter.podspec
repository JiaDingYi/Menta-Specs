Pod::Spec.new do |s|
    ...
    s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionAdapter/5.20.15/MentaVlionAdapter-5.20.15.tar.bz2' } 
    ...
    s.dependency 'MentaVlionSDK', '~> 5.20.15'
