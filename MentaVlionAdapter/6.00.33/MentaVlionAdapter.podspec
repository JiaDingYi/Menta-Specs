Pod::Spec.new do |s|
    ...
    s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionAdapter/6.00.33/MentaVlionAdapter-6.00.33-20250528174920.tar.bz2' } 
    ...
    s.dependency 'MentaVlionSDK', '~> 6.00.33'
