Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionBaseSDK/6.00.31.11/MentaVlionBaseSDK-6.00.31.11-20250326180945.tar.bz2' } 
  s.platform    = :ios 
