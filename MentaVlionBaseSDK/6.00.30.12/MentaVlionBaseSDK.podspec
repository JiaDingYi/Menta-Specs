Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionBaseSDK/6.00.30.12/MentaVlionBaseSDK-6.00.30.12-20250312172147.tar.bz2' } 
  s.platform    = :ios 
