Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionBaseSDK/6.00.30.11/MentaVlionBaseSDK-6.00.30.11-20250312170304.tar.bz2' } 
  s.platform    = :ios 
