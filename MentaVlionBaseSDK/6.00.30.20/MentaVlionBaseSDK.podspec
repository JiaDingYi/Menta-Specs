Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaVlionBaseSDK/6.00.30.20/MentaVlionBaseSDK-6.00.30.20-20250312191537.tar.bz2' } 
  s.platform    = :ios 
