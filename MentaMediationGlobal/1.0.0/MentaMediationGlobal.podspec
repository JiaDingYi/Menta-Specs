Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaMediationGlobal/1.0.0/MentaMediationGlobal-1.0.0-20240626171627.tar.bz2' } 
  ...
  s.dependency 'MentaBaseGlobal', '1.0.0'
