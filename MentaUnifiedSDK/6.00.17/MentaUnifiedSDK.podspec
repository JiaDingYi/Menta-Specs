Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaUnifiedSDK/6.00.17/MentaUnifiedSDK-6.00.17-20241115160952.tar.bz2' } 
  ...
  s.dependency 'MentaVlionBaseSDK', '~> 6.00.17'
