Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaUnifiedSDK/4.00.06.02/MentaUnifiedSDK-4.00.06.02-20250507154156.tar.bz2' } 
  ...
  s.dependency 'MentaVlionBaseSDK', '~> 4.00.06.02'
