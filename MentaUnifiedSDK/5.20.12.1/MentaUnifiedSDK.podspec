Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://bj-menta-sdk.oss-cn-beijing.aliyuncs.com/iOS/MentaUnifiedSDK/5.20.12.1/MentaUnifiedSDK-5.20.12.1.tar.bz2' } 
  ...
  s.dependency 'MentaVlionBaseSDK', '~> 5.20.12'
